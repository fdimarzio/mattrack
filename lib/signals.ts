...
export const SIGNALS: Signal[] = [
  ...
  // ── MATCH CONTROL ─────────────────────────────────────────
  {
    ...
    notes: 'Ref points down to mat — whistle reviewed separately',
  },
  {
    id: 'stopping_match',
    label: 'Stopping the Match',
    points: 0, category: 'control', color: '#a78bfa',
    notes: 'Ref arm extended palm out — whistle reviewed separately',
  },
  {
    id: 'timeout',
    label: 'Time Out',
  ...
  },
  {
    ...
    notes: 'Arm extended pointing out of bounds — also stops clock. Whistle reviewed separately.',
  },
  {
  ...
  // ── OUTCOMES ───────────────────────────────────────────────
  {
    ...
    requiresWrestler: true,
    notes: 'Red wins by pin — ref slaps mat. Whistle reviewed separately.',
  },
  {
    id: 'pin_green',
    ...
    points: 6, category: 'outcome', color: '#ff0055',
    requiresWrestler: true,
    notes: 'Green wins by pin — ref slaps mat. Whistle reviewed separately.',
  },
  {
    id: 'tech_fall_red',
